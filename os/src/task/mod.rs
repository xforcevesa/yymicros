...
//!
//! Be careful when you see [`__switch_task`]. Control flow around this function
...
lazy_static! {
    ...
    pub static ref INITPROC: Arc<ProcessControlBlock> = {
        let inode = open_file("/bin/shell.elf", OpenFlags::RDONLY).unwrap();
